# This chunk of code selects 110 coronal slices from the baseline volume, and 110 coronal slices from M06
#calculated from the middle slice of the origional volume and save a new volume of shape 110x110x220.
...
def get_images(dir_path, dir1, dir2, sav_vol_pth):
   ...
   for indx, sub_pth in enumerate(glob.glob(dir_path)):
       ...
       all_imges_pth =  bl_pths + m06_pths
       volume = 0
