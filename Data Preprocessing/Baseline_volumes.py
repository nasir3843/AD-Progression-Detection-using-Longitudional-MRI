# This chunk of code selects 110 coronal slices for the baseline volume
#calculated from the middle slice of the origional volume and save a new volume of shape 110x110x110.
import numpy as np
import os
import zipfile
import numpy as np
...
# Directory path to save selected slices during volume creation process
