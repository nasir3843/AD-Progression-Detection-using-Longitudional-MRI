...
standardize_features = '/home/ubuntu/nasir/pytorch_3d_resnet_data/three_step_oversampling/standardized_features.csv'
...
class Dataset_Early_Fusion(Dataset):
    def __init__(self, df, indices):
        ...
        columns_to_drop =  ['Unnamed: 0', 'Unnamed: 0.1', 'AGE', 'PTGENDER', 'PTEDUCAT', 'Subject_id']  
...
np.save('./pytorch_3d_resnet_data/label_prediction_np_arrays/CNN_RNN-Single_Steps.npy',z)
