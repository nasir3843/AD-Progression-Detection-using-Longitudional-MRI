...
#                                                   cycle_momentum=False)
    ...
    for e in t:    
        ...
        if(old_acc==val_acc) and (old_auc<val_auc):
            ...
            save_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/three_step_oversampling/CNN_RNN-3_Steps_with_all_features_bestmodels/resnet_three_steps_all_features_fold_' + str(fold)
...
np.save('/home/ubuntu/nasir/pytorch_3d_resnet_data/three_step_oversampling/CNN_RNN-3_Steps_with_all_features_bestmodels/resnet_three_steps_all_features.npy', 
       z)
