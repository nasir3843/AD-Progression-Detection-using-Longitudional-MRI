...
#                                                   cycle_momentum=False)
    ...
    for e in t:    
        ...
        if(old_acc==val_acc) and (old_auc<val_auc):
            ...
            save_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/two_steps_with_oversampling/two_steps_all_features_weights/resnet_two_steps_all_features_fold_' + str(fold)
...
np.save('/home/ubuntu/nasir/pytorch_3d_resnet_data/two_steps_with_oversampling/two_steps_all_features_weights/resnet-Two_Step_All_Features_results.npy', 
       z)
