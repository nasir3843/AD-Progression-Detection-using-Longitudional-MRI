...
standardize_features = '/home/ubuntu/nasir/pytorch_3d_resnet_data/single_step_with_oversampling/standardized_features.csv'
...
class Dataset_Early_Fusion(Dataset):
    def __init__(self, df, indices):
        ...
        columns_to_drop = ['Unnamed: 0', 'FDG', 'TAU','PTAU',
                           'APOE4','CDRSB',
...
class ResNet3D(nn.Module):
    ...
    def forward(self, x, f):
        ...
        sequences = x.reshape(-1, 2, 512)       
        out = self.rnn(sequences)
        out = self.dense_layer1(out)
        
        dens_output = self.dense_layer1(out)     
        
        dense_layer2 = self.dense_layer2(f)
        cat_features = torch.cat((out, dense_layer2), 1)        
...
def train(train_dataloader, val_dataloader, fold):
    ...
    for e in t:    
        ...
        if(old_acc==val_acc) and (old_auc<val_auc):
            ...
            save_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/scripts/Repeated_Experiments/ResNet_single_step_demographic_fold_' + str(fold)
...
for indx, (train_index, test_index) in enumerate(skf.split(all_pths, all_labels)):  
    ...
    train_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/one_step/Train_Fold_single' + str(indx) + '.csv'
    ...
    valid_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/one_step/Valid_Fold_single' + str(indx) + '.csv'
...
np.save('/home/ubuntu/nasir/pytorch_3d_resnet_data/scripts/Repeated_Experiments/ResNet_single_step_demographic.npy', 
       z)
...
single_step_mri = np.load('/home/ubuntu/nasir/pytorch_3d_resnet_data/scripts/Repeated_Experiments/ResNet_single_step_demographic.npy',allow_pickle=True)
