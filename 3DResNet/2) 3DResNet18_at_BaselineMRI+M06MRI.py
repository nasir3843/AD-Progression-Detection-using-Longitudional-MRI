...
def train(train_dataloader, val_dataloader, fold):
    ...
    for e in t:    
        ...
        if(old_acc==val_acc) and (old_auc<val_auc):
            ...
            save_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/scripts/Repeated_Experiments/Proposed_network/resnet_two_steps_without_features_fold_' + str(fold)            
...
np.save('/home/ubuntu/nasir/pytorch_3d_resnet_data/scripts/Repeated_Experiments/Proposed_network/resnet-Two_Steps_without_Features_results.npy', 
       z)
...
def mean_std(net_pred1, y_true1):    
    ...
    single_step_mri = np.load('/home/ubuntu/nasir/pytorch_3d_resnet_data/scripts/Repeated_Experiments/Proposed_network/resnet-Two_Steps_without_Features_results.npy',allow_pickle=True)
