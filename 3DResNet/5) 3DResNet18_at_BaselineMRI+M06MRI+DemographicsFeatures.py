...
for indx, (train_index, test_index) in enumerate(skf.split(all_pths, all_labels)):  
    ...
    train_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/two_steps/Train_Fold' + str(indx) + '.csv'
    ...
    valid_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/two_steps/Valid_Fold' + str(indx) + '.csv'
...
np.save('/home/researchsrv1/Documents/nasir/Paper1/3DCNN/skull_striped_dataset/pytorch_3d_resnet_data/label_prediction_np_arrays/CNN_RNN-Single_Steps.npy', 
       z)
...
single_step_mri = np.load('/home/ubuntu/nasir/pytorch_3d_resnet_data/scripts/Repeated_Experiments/resnet-Two_Step_demographic.npy',allow_pickle=True)
