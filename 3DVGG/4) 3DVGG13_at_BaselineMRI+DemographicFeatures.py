...
standardize_features = '/home/ubuntu/nasir/pytorch_3d_resnet_data/single_step/standardized_feature.csv'
...
#                                                   cycle_momentum=False)
    ...
    for e in t:    
        ...
        if(old_acc==val_acc) and (old_auc<val_auc):
            ...
            save_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/scripts/Repeated_Experiments/vgg_13_single_step_demographic_fold_' + str(fold)
...
for indx, (train_index, test_index) in enumerate(skf.split(all_pths, all_labels)):  
    ...
    train_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/one_step/Train_Fold_single_cog_sing1' + str(indx) + '.csv'
    ...
    valid_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/one_step/Valid_Fold_single_cog_sing1' + str(indx) + '.csv'
    ...
    print('valid data: ', validdf.shape)
...
np.save('/home/ubuntu/nasir/pytorch_3d_resnet_data/scripts/Repeated_Experiments/VGG13-Single_Step_demographic.npy', z)      
...
single_step_mri = np.load('/home/ubuntu/nasir/pytorch_3d_resnet_data/scripts/Repeated_Experiments/VGG13-Single_Step_demographic.npy',allow_pickle=True)
