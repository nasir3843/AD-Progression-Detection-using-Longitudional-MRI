...
class Dataset_Early_Fusion(Dataset):
    def __init__(self, df, indices):
        ...
        columns_to_drop = ['Unnamed: 0', 'Unnamed: 0.1', 'FDG', 'TAU','PTAU','APOE4','CDRSB',
...
for indx, (train_index, test_index) in enumerate(skf.split(all_pths, all_labels)):  
    ...
    train_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/three_steps/Train_Fold1_vgg_3_steps' + str(indx) + '.csv'
    ...
    valid_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/three_steps/Valid_Fold1vgg_3_steps' + str(indx) + '.csv'
    ...
    cur_result = train(train_dataloader, valid_dataloader)
...
np.save('/home/ubuntu/nasir/pytorch_3d_resnet_data/scripts/Repeated_Experiments/VGG13-Three_Steps_demographic.npy', z)      
...
single_step_mri = np.load('/home/ubuntu/nasir/pytorch_3d_resnet_data/scripts/Repeated_Experiments/VGG13-Three_Steps_demographic.npy',allow_pickle=True)
