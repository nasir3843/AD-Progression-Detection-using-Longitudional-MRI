...
normal_scan_paths = glob.glob('/home/ubuntu/nasir/pytorch_3d_resnet_data/three_step/1.CN/*.*')
...
standardize_features = '/home/ubuntu/nasir/pytorch_3d_resnet_data/three_step/standardized_features.csv'
...
class VGG3D13(nn.Module):
    def __init__(self, num_classes=2, input_shape=(1,110,110,110)): # input: input_shape:	[num_of_filters, kernel_size] (e.g. [256, 25])
        ...
        self.dense_layer1 = nn.Sequential(nn.Linear((512 * 3) * 2, 256),
                             nn.ReLU(),
                             nn.Dropout(0.4),
                             nn.Linear(256, 128),
                             nn.ReLU())
...
#                                                   cycle_momentum=False)
    ...
    for e in t:    
        ...
        if(old_acc==val_acc) and (old_auc<val_auc):
            ...
            save_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/scripts/Repeated_Experiments/Proposed_network/vgg13_three_steps_without_features_fold_' + str(fold)
...
for indx, (train_index, test_index) in enumerate(skf.split(all_pths, all_labels)):  
    ...
    train_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/one_step/Train_Fold_single_cog_sing10' + str(indx) + '.csv'
    ...
    valid_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/one_step/Train_Fold_single_cog_sing10' + str(indx) + '.csv'
...
np.save('/home/ubuntu/nasir/pytorch_3d_resnet_data/scripts/Repeated_Experiments/Proposed_network/vgg_13_three_steps_without_features.npy', 
       z)
...
single_step_mri = np.load('/home/ubuntu/nasir/pytorch_3d_resnet_data/scripts/Repeated_Experiments/Proposed_network/vgg_13_three_steps_without_features.npy',allow_pickle=True)
