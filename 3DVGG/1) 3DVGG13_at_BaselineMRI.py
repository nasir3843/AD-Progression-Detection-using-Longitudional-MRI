...
class VGG3D13(nn.Module):
    def __init__(self, num_classes=2, input_shape=(1,110,110,110)): 
        ...
        self.dense_layer1 = nn.Sequential(nn.Linear((512 * 2) * 2, 256),
                                 nn.ReLU(),
                                 nn.Dropout(0.4),
                                 nn.Linear(256, 128),
                                 nn.ReLU())
...
#                                                   cycle_momentum=False)
    ...
    for e in t:    
        ...
        if(old_acc==val_acc) and (old_auc<val_auc):
            ...
            save_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/scripts/Repeated_Experiments/Proposed_network/vgg_13_single_step_no_features_fold_' + str(fold)
...
np.save('/home/ubuntu/nasir/pytorch_3d_resnet_data/scripts/Repeated_Experiments/Proposed_network/VGG13-Single_Step_MRI_only.npy', z)      
...
single_step_mri = np.load('/home/ubuntu/nasir/pytorch_3d_resnet_data/scripts/Repeated_Experiments/Proposed_network/VGG13-Single_Step_MRI_only.npy',allow_pickle=True)
