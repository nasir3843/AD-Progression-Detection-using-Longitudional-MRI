...
#                                                   cycle_momentum=False)
    ...
    for e in t:    
        ...
        if(old_acc==val_acc) and (old_auc<val_auc):
            ...
            save_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/single_step_with_oversampling/single_step_demographic/vgg_13_single_step_mri_only_fold_' + str(fold)
...
np.save('/home/ubuntu/nasir/pytorch_3d_resnet_data/single_step_with_oversampling/single_step_demographic/VGG13-Single_Step_MRI_only.npy', z)      
