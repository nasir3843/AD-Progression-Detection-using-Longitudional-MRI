...
#                                                   cycle_momentum=False)
    ...
    for e in t:    
        ...
        if(old_acc==val_acc) and (old_auc<val_auc):
            ...
            save_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/three_step/CNN_RNN-3_Steps_with_all_features_bestmodels/vgg13_three_steps_all_features_fold_' + str(fold)
...
for indx, (train_index, test_index) in enumerate(skf.split(all_pths, all_labels)):  
    ...
    valid_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/one_step/Train_Fold_single_cog_sing5' + str(indx) + '.csv'
...
np.save('/home/ubuntu/nasir/pytorch_3d_resnet_data/three_step/CNN_RNN-3_Steps_with_all_features_bestmodels/vgg13_three_steps_all_features.npy', 
       z)
...
def mean_std(net_pred, y_true):    
    ...
    for i in range(1, 6, 1):
        ...
        all_auc.append(metrics.roc_auc_score(y_true, torch.max(y_pred, 1)[1]))
