...
def train(train_dataloader, val_dataloader, fold):
    ...
    for e in t:    
        ...
        if(old_acc==val_acc) and (old_auc<val_auc):
            ...
            save_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/two_steps_with_oversampling/two_steps_all_features_weights/two_steps_allfeatures_fold_' + str(fold)
...
np.save('/home/ubuntu/nasir/pytorch_3d_resnet_data/two_steps_with_oversampling/two_steps_all_features_weights/CNN_RNN-Two_Steps.npy', 
       z)
