...
standardized_features = '/home/ubuntu/nasir/pytorch_3d_resnet_data/two_steps/standardized_features.csv'
...
def train(train_dataloader, val_dataloader, fold):
    ...
    for e in t:    
        ...
        if(old_acc==val_acc) and (old_auc<val_auc):
            ...
            save_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/scripts/Repeated_Experiments/Exp_with_demographics/two_steps_cognitive_fold_' + str(fold)
...
np.save('/home/ubuntu/nasir/pytorch_3d_resnet_data/scripts/Repeated_Experiments/Exp_with_demographics/CNN_RNN-two_steps_cognitive_features.npy', 
       z)
