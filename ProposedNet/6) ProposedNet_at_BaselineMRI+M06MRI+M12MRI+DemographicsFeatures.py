...
abnormal_scan_paths = glob.glob('/home/ubuntu/nasir/pytorch_3d_resnet_data/three_steps/2.AD/*.*')
all_pths = normal_scan_paths + abnormal_scan_paths
standardize_features = '/home/ubuntu/nasir/pytorch_3d_resnet_data/three_steps/standardized_features.csv'
...
class ProposedNet(nn.Module):
    ...
    def forward(self, x1, x2, x3, f):
        ...
        cat_features = torch.cat((dens_output, out), 1)        
...
for indx, (train_index, test_index) in enumerate(skf.split(all_pths, all_labels)):  
    ...
    train_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/two_steps/Train_Fold_pn3' + str(indx) + '.csv'
    ...
    valid_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/two_steps/Valid_Fold_pn3' + str(indx) + '.csv'
