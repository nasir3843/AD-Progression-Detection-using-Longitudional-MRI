...
standardize_features = '/home/ubuntu/nasir/pytorch_3d_resnet_data/two_steps_with_oversampling/standardized_features_with_oversampling.csv' 
...
def train(train_dataloader, val_dataloader, fold):
    ...
    for e in t:    
        ...
        if(old_acc==val_acc) and (old_auc<val_auc):
            ...
            save_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/scripts/Repeated_Experiments/Exp_with_demographics/three_steps_cognitive_features_fold_' + str(fold)
...
for indx, (train_index, test_index) in enumerate(skf.split(all_pths, all_labels)):  
    ...
    train_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/three_steps/Train_Fold_cog_feat120' + str(indx) + '.csv'
    ...
    valid_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/three_steps/Train_Fold_cog_feat120' + str(indx) + '.csv'
...
z = {'net prediction: ' : test_y_pred, 'true labels: ' : test_y_true}
np.save('/home/ubuntu/nasir/pytorch_3d_resnet_data/scripts/Repeated_Experiments/Exp_with_demographics/CNN_RNN-three_steps_cognitive_features.npy', 
       z)
