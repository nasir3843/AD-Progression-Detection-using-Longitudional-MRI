...
standardized_features = '/home/ubuntu/nasir/pytorch_3d_resnet_data/single_step/standardized_features_with_oversampling.csv'
...
def train(train_dataloader, val_dataloader, fold):
    ...
    for e in t:    
        ...
        if(old_acc==val_acc) and (old_auc<val_auc):
            ...
            save_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/scripts/Repeated_Experiments/Exp_with_demographics/CNN_RNN_single_step_demographic_features_fold_' + str(fold)
...
for indx, (train_index, test_index) in enumerate(skf.split(all_pths, all_labels)):  
    ...
    train_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/three_steps/Train_Fold_cog_feat117' + str(indx) + '.csv'
    ...
    valid_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/three_steps/Train_Fold_cog_feat117' + str(indx) + '.csv'
...
np.save('/home/ubuntu/nasir/pytorch_3d_resnet_data/scripts/Repeated_Experiments/Exp_with_demographics/CNN_RNN-single_steps_demographic_features.npy', 
       z)
...
single_step_mri = np.load('/home/ubuntu/nasir/pytorch_3d_resnet_data/scripts/Repeated_Experiments/Exp_with_demographics/CNN_RNN-single_steps_demographic_features.npy',allow_pickle=True)
mean_std(single_step_mri.item().get('net prediction: '), single_step_mri.item().get('true labels: '))
