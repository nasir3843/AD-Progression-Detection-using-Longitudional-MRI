...
normal_scan_paths = glob.glob('/home/ubuntu/nasir/pytorch_3d_resnet_data/two_steps_with_oversampling/1.CN/*.*')
abnormal_scan_paths = glob.glob('/home/ubuntu/nasir/pytorch_3d_resnet_data/two_steps_with_oversampling/2.AD/*.*')
all_pths = normal_scan_paths + abnormal_scan_paths

standardized_features = '/home/ubuntu/nasir/pytorch_3d_resnet_data/two_steps_with_oversampling/standardized_features_with_oversampling.csv'
...
def train(train_dataloader, val_dataloader, fold):
    ...
    for e in t:    
        ...
        if(old_acc==val_acc) and (old_auc<val_auc):
            ...
            save_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/scripts/Repeated_Experiments/Exp_with_demographics/CNN_RNN_two_steps_demographic_features_fold_' + str(fold)
...
for indx, (train_index, test_index) in enumerate(skf.split(all_pths, all_labels)):  
    ...
    train_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/three_steps/Train_Fold_cog_feat116' + str(indx) + '.csv'
    ...
    valid_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/three_steps/Train_Fold_cog_feat116' + str(indx) + '.csv'
...
np.save('/home/ubuntu/nasir/pytorch_3d_resnet_data/scripts/Repeated_Experiments/Exp_with_demographics/CNN_RNN-two_steps_demographic_features.npy', 
       z)
