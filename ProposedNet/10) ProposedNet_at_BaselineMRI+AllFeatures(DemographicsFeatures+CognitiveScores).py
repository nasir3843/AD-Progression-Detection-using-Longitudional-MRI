...
abnormal_scan_paths = glob.glob('/home/ubuntu/nasir/pytorch_3d_resnet_data/single_step2.AD_/*.*')
all_pths = normal_scan_paths + abnormal_scan_paths

standardize_features = '/home/ubuntu/nasir/pytorch_3d_resnet_data/single_step/standardized_features.csv'
...
def train(train_dataloader, val_dataloader, fold):
    ...
    for e in t:    
        ...
        if(old_acc==val_acc) and (old_auc<val_auc):
            ...
            save_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/single_step/Single_step_all_features/single_step_allfeatures_fold_' + str(fold)
...
for indx, (train_index, test_index) in enumerate(skf.split(all_pths, all_labels)):  
    ...
    train_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/two_steps/Train_Fold_pn8' + str(indx) + '.csv'
    ...
    valid_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/two_steps/Valid_Fold_pn8' + str(indx) + '.csv'
...
np.save('/home/ubuntu/nasir/pytorch_3d_resnet_data/single_step_with_oversampling/Single_step_all_features/CNN_RNN-Single_Step_all_features.npy', 
       z)
...
single_step_mri = np.load('/home/ubuntu/nasir/pytorch_3d_resnet_data/three_step_oversampling/CNN_RNN-3_Steps_with_all_features_bestmodels/resnet_three_steps_all_features.npy',allow_pickle=True)
