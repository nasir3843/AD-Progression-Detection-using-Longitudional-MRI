...
def train(train_dataloader, val_dataloader, fold):
    ...
    for e in t:    
        ...
        if(old_acc==val_acc) and (old_auc<val_auc):
            ...
            save_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/three_step_oversampling/CNN_RNN-3_Steps_with_all_features_bestmodels/fold_' + str(fold) + 'epoch_' + str(e)
...
test_precision = metrics.precision_score(test_y_true, torch.max(test_y_pred, 1)[1])
test_recall = metrics.recall_score(test_y_true, torch.max(test_y_pred, 1)[1])
test_ap = metrics.average_precision_score(test_y_oldtrue, torch.max(test_y_pred, 1)[1])
...
save_path = '/home/ubuntu/nasir/pytorch_3d_resnet_data/three_step_oversampling/CNN_RNN-3_Steps_with_all_features_bestmodels/all_y_pred/CNN_RNN-3_Steps_with_Features.npy'
np.save(save_path, z)
